...
public interface IToolchain
{
    ...
    async Task<CompilerBase> CreateCompiler(ModuleBase module, IModuleInstancingParams instancingParams)
    {
    ...
    async Task<LinkerBase> CreateLinker(ModuleBase module, IModuleInstancingParams instancingParams)
    {
